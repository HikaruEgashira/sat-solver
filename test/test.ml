...
(* let _ =
   ...
   print_endline "\nRET";
   let ret1 = Solver.DFS.solve cnf |> Util.debug_ret in
   let ret2 = Solver.DPLL.solve cnf |> Util.debug_ret in
...
let test1 =
  QCheck.Test.make ~name:"unit_propagation should same as depth_first_search"
    ...
    (fun (seed, v, l, c) ->
      ...
      if ret1 = ret2 then true (* SAT or UNSAT *)
        ...
        let res1 = Solver_dpll.assign_cnf cnf.clauses ret1 in
        let res2 = Solver_dpll.assign_cnf cnf.clauses ret2 in
        res1 = res2)
